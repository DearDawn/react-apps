...
export const App = (props: IProps) => {
  ...
  return (
    <Page maxWidth='100vw' className={styles.app}>
      ...
      <Title className={styles.title}><a href="./home/">短链接生成器</a></Title>
      <Title className={styles.title}><a href="./home/">网页截图</a></Title>
      <Title className={styles.title}><a href="./home/">破碎 & 完整</a></Title>
    </Page>
  )
}
